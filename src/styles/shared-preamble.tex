...
% Custom description list with bullet + bold label + colon
% Renders as: • Model Loading: Description text here...
\setlist[description]{
  labelwidth=!,
  itemsep=0.5em,
  before=\vspace{0.3em},
  font=\normalfont\textbullet~\bfseries,
  style=nextline
}
% Add colon after description labels
\renewcommand{\descriptionlabel}[1]{\hspace{\labelsep}\textbullet~\textbf{#1:}}
...
\hypersetup{
  ...
  filecolor=magenta,
  urlcolor=cyan,
  pdftitle={Inference is all you need (Title TBD)},
  pdfauthor={Sriram Panyam},
...
\newcommand{\calcbaseurl}{http://localhost:8088}
