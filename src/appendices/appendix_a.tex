...
The control plane exposes Prometheus metrics for monitoring and alerting.

\begin{programcode}{Core Metrics}
\begin{lstlisting}[language=Go]
// Metrics registered with Prometheus.
var (
    // RequestsTotal counts requests by model and status.
    ...
    // TokensGenerated counts output tokens.
    ...
    // BackendHealthy indicates backend status (1=up, 0=down).
    BackendHealthy = prometheus.NewGauge(
        prometheus.GaugeOpts{
            Name: "inference_backend_healthy",
