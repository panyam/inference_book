...
\usepackage[T1]{fontenc}     % proper font encoding for quotes
...
\usepackage{upquote}         % preserve straight quotes in listings
...
% Code listing style defaults - optimized for copy-paste
\lstset{
