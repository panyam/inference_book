...
\contentsline {subsection}{\numberline {}and Solutions}{17}{subsection.1.2.8}
...
\contentsline {subsection}{\numberline {2.11}{\sc SVMono} Chapterwise Bibliography}{20}{subsection.1.2.11}
\contentsline {subsection}{\numberline {2.12}{\sc SVMono} Commands for Styling the Index}{20}{subsection.1.2.12}
\contentsline {subsection}{\numberline {2.13}{\sc SVMono} Commands for Styling the Table of Contents}{20}{subsection.1.2.13}
\contentsline {section}{{\bf References}}{{\bf 21}}{section*.4}
...
\verb|\Description| is intended to be used instead of the image.

When it comes to the alternative texts perhaps it is helpful to
include a sentence that only unstructured text is allowed, e.g. no
special characters, line breaks, equations, or lists etc., or any other
formatting like italics or bold/bolditalic are also not possible.
...
\subsection{SVMono Chapterwise Bibliography}

\noindent
{\bf Reference for Numbered}

\cprotect\boxtext{\verb|\documentclass[graybox,envcountchap,sectrefs]{svmono}|}

Please refer \verb|book.tex| and \verb|references.tex| for further reference.

\noindent
{\bf Reference for Name and Year}

Use the option \verb|natbib| in documentclass.

\cprotect\boxtext{\verb|\documentclass[graybox,envcountchap,sectrefs,natbib]{svmono}|}

Use the command in preamble.

\cprotect\boxtext{\verb|\usepackage{chapterbib}|}

Use the \verb|bibliograpy.bib| and relevant \verb|.bst| at the end of the chapter.

The command

\cprotect\boxtext{\verb|\bibliographystyle{spbasic}|
\verb|\bibliography{bibliography}|}

Please refer \verb|bookbib.tex| and \verb|chapbib.tex| for further
reference.
